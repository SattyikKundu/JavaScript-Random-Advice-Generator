...
## I. Example Output (after running program in terminal):
Terminal command (assuming you installed Node.js): \
...
- Experience with various Git/GitHub commands(i.e. clone, pull, commit, push, etc.).
...
## III. Possible way(s) to expand program later on:
